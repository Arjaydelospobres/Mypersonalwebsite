...
import {
  require_prop_types
} from "./chunk-3JB32BIG.js";
import "./chunk-J2MBPAUX.js";
import {
  _extends
  ...
  "node_modules/react-view-pager/lib/Pager.js"(exports, module) {
    ...
    var Pager = function() {
      function Pager2() {
        ...
        this.options = _extends3({}, defaultOptions, options);
    ...
    var Track2 = function(_Component2) {
      ...
      _createClass(Track3, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
          ...
          if ((typeof currentView === "undefined" ? "undefined" : _typeof(currentView)) !== void 0 && this.props.currentView !== currentView) {
...
var require_utilities2 = __commonJS({
  "node_modules/html-react-parser/lib/utilities.js"(exports, module) {
    ...
    var PRESERVE_CUSTOM_ATTRIBUTES = React27.version.split(".")[0] >= 16;
...
var require_dom_to_react = __commonJS({
  "node_modules/html-react-parser/lib/dom-to-react.js"(exports, module) {
    ...
    function domToReact2(nodes, options) {
      options = options || {};
      var library = options.library || React27;
...
var RemoveScroll = React4.forwardRef(function(props, parentRef) {
  ...
  return React4.createElement(
    ...
    forwardProps ? React4.cloneElement(React4.Children.only(children2), __assign(__assign({}, containerProps), { ref: containerRef })) : React4.createElement(Container3, __assign({}, containerProps, { className: className2, ref: containerRef }), children2)
  );
});
...
var InFocusGuard = function InFocusGuard2(_ref) {
  ...
  return React5.createElement(React5.Fragment, null, React5.createElement("div", {
    ...
    style: hiddenGuard
  }), children2, children2 && React5.createElement("div", {
    key: "guard-last",
    "data-focus-guard": true,
    "data-focus-auto-guard": true,
    style: hiddenGuard
...
var FocusLock = React6.forwardRef(function FocusLockUI(props, parentRef) {
  ...
  return React6.createElement(React6.Fragment, null, hasLeadingGuards && [
    ...
    onBlur: onBlur3,
    onFocus: onFocus3
  }), children2), hasTailingGuards && React6.createElement("div", {
    "data-focus-guard": true,
    tabIndex: disabled ? -1 : 0,
    style: hiddenGuard
  }));
...
var AutoFocusInside = function AutoFocusInside2(_ref) {
  ...
  return React7.createElement("div", _extends({}, inlineProp(FOCUS_AUTO, !disabled), {
    className: className2
  }), children2);
};
...
function MoveFocusInside(_ref) {
  var isDisabled = _ref.disabled, className2 = _ref.className, children2 = _ref.children;
  var ref = React8.useRef(null);
  useFocusInside(isDisabled ? void 0 : ref);
  return React8.createElement("div", _extends({}, inlineProp(FOCUS_AUTO, !isDisabled), {
    ref,
    className: className2
  }), children2);
}
...
var FreeFocusInside = function FreeFocusInside2(_ref) {
  ...
  return React9.createElement("div", _extends({}, inlineProp(FOCUS_ALLOW, true), {
    className: className2
  }), children2);
};
...
// node_modules/react-focus-on/dist/es2015/UI.js
var FocusOn = React10.forwardRef(function(props, parentRef) {
  var _a = React10.useState(false), lockProps = _a[0], setLockProps = _a[1];
  ...
  return React10.createElement(
    React10.Fragment,
    null,
    React10.createElement(UI_default, { ref: parentRef, sideCar, disabled: !(lockProps && enabled && focusLock), returnFocus, autoFocus, shards, onActivation, onDeactivation, className: className2, whiteList: shouldIgnore, lockProps: appliedLockProps, focusOptions: preventScrollOnFocus ? { preventScroll: true } : void 0, as: RemoveScroll }, children2),
    enabled && React10.createElement(SideCar2, __assign({}, rest, { sideCar: effectCar2, setLockProps, shards }))
  );
});
...
function RemoveScrollSideCar(props) {
  ...
  var Style3 = React15.useState(styleSingleton)[0];
  ...
  return React15.createElement(
    React15.Fragment,
    null,
    inert ? React15.createElement(Style3, { styles: generateStyle(id) }) : null,
...
var InteractivityDisabler = function() {
  return React16.createElement(Style2, { styles });
};
...
function Effect(_a) {
  ...
  var _b = (0, import_react6.useState)(void 0), activeNode = _b[0], setActiveNode = _b[1];
  var lastEventTarget = (0, import_react6.useRef)(null);
  var mouseTouches = (0, import_react6.useRef)(0);
  ...
  return React17.createElement(InteractivityDisabler, null);
}
...
var RequireSideCar = function(props) {
  return React18.createElement(sidecar_default3, __assign({}, props));
};
var FocusOn2 = React18.forwardRef(function(props, ref) {
  return React18.createElement(FocusOn, __assign({}, props, { ref, sideCar: RequireSideCar }));
});
...
function getNextChildMapping(nextProps, prevChildMapping, onExited) {
  ...
  Object.keys(children2).forEach(function(key2) {
    ...
    if (hasNext && (!hasPrev || isLeaving)) {
      children2[key2] = (0, import_react11.cloneElement)(child, {
        onExited: onExited.bind(null, child),
        in: true,
...
var Fade = function Fade2(_ref) {
  ...
  return import_react15.default.createElement(
    ...
    function(status) {
      ...
      if (status === "exited")
        return null;
      return import_react15.default.createElement(Tag, _extends2({ innerProps }, props));
    }
  );
};
...
var Modal = function(_Component) {
  ...
  createClass(Modal2, [{
    ...
    value: function render() {
      ...
      var carouselComponent = (0, import_react15.cloneElement)(children2, {
        isModal: true,
        modalProps
      });
      return (0, import_glam.default)(
...
var FirstChild = function FirstChild2(_ref) {
  var children2 = _ref.children;
  return import_react15.Children.toArray(children2)[0] || null;
};
var ModalGateway = function(_Component) {
  ...
  createClass(ModalGateway2, [{
    ...
    value: function render() {
      ...
      return (0, import_react_dom3.createPortal)(import_react15.default.createElement(TransitionGroup_default, { component: FirstChild, children: children2 }), target);
    }
  }]);
